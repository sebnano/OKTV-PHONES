...
class CustomEditText  : AppCompatEditText {
    ...
    private fun selectTypeface(context: Context, textStyle: Int): Typeface {
        return when (textStyle) {
            Typeface.BOLD -> Typeface.createFromAsset(context.assets, "Poppins-Medium.ttf")
            Typeface.NORMAL -> Typeface.createFromAsset(context.assets, "Poppins-Regular.ttf")// regular
